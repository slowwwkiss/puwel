    ...
    var t = {
        487: function() {
            ...
            window.tram = function(t) {
                ...
                }, d = window, p = "bkwld-tram", v = /[\-\.0-9]/g, m = /[A-Z]/, w = "number", b = /^(rgb|#)/, g = /(em|cm|mm|in|pt|pc|px)$/, y = /(em|cm|mm|in|pt|pc|px|%)$/, x = /(deg|rad|turn)$/, k = "unitless", E = /(all|none) 0s ease 0s/, _ = /^(width|height)$/, L = document.createElement("a"), z = ["Webkit", "Moz", "O", "ms"], A = ["-webkit-", "-moz-", "-o-", "-ms-"], $ = function(t) {
                    if (t in L.style)
                        return {
                            dom: t,
                            css: t
                ...
                var S = e.frame = (s = d.requestAnimationFrame || d.webkitRequestAnimationFrame || d.mozRequestAnimationFrame || d.oRequestAnimationFrame || d.msRequestAnimationFrame) && q.bind ? s.bind(d) : function(t) {
                  ...
                  , F = l(function(e) {
                    ...
                    function l() {
                        ...
                        this.el.style[q.transition.dom] = n)
                    }
                    function h(t, e, i) {
                        var r, o, a, s, u = e !== f, c = {};
                        for (r in t)
                            a = t[r],
                            r in Z ? (c.transform || (c.transform = {}),
                  ...
                  , N = l(function(t) {
                    ...
                    t.init = function(t, e, n, i) {
                        ...
                        this.string = this.name + " " + this.duration + "ms" + ("ease" != this.ease ? " " + h[this.ease][0] : "") + (this.delay ? " " + this.delay + "ms" : ""))
                    }
                    ,
                    t.set = function(t) {
                  ...
                  , I = l(N, function(t, e) {
                    ...
                    t.init = function() {
                        ...
                        Z.perspective && H.perspective && (this.current.perspective = H.perspective,
                ...
                q.transform && q.backface && (Z.z = [y, "translateZ"],
                Z.rotateZ = [x],
                Z.scaleZ = [w],
                Z.perspective = [g]);
                var Y = /ms/
        ...
        756: function(t, e, n) {
            "use strict";
            var i, r, o, a, s, u, c, l, h, f, d, p, v, m, w, b, g, y, x, k, E = window.$, _ = n(487) && E.tram;
        ...
        461: function(t, e, n) {
            ...
            i.define("brand", t.exports = function(t) {
                ...
                return n.ready = function() {
                    var n, i, a, f = o.attr("data-wf-status"), d = o.attr("data-wf-domain") || "";
                    /\.webflow\.io$/i.test(d) && s.hostname !== d && (f = !0),
        ...
        949: function(t, e, n) {
            "use strict";
            var i, r, o = {}, a = {}, s = [], u = window.Webflow || [], c = window.jQuery, l = c(window), h = c(document), f = c.isFunction, d = o._ = n(756), p = o.tram = n(487) && c.tram, v = !1, m = !1;
            function w(t) {
            ...
            y && h.on("touchstart mousedown", function(t) {
                i = t.target
            }),
        ...
        624: function(t, e, n) {
            ...
            i.define("links", t.exports = function(t, e) {
                var n, r, o, a = {}, s = t(window), u = i.env(), c = window.location, l = document.createElement("a"), h = "w--current", f = /index\.(html|php)$/, d = /\/$/;
                function p() {
                    var t = s.scrollTop()
                      , n = s.height();
                    e.each(r, function(e) {
                ...
                function w(e) {
                    ...
                    if (!(i.env("design") || window.$.mobile && /(?:^|\s)ui-link(?:$|\s)/.test(a.className))) {
                        ...
                        if ("" !== c) {
                            ...
                            e.stopPropagation()),
                            h = c,
                            n.hash !== h && r && r.pushState && !(i.env.chrome && "file:" === n.protocol) && (r.state && r.state.hash) !== h && r.pushState({
                                hash: h
                            }, "", h),
                ...
                function i(e) {
                    ...
                    function c(e) {
                        if (o) {
                            ...
                            var i, u, c, l, f = e.touches, d = f ? f[0].clientX : e.clientX, p = d - r;
                            r = d,
